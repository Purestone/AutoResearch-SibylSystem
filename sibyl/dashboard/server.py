...
def create_app(config: Config | None = None) -> Flask:
    ...
    def _collect_system_status() -> dict:
        ...
        return {
            ...
            "skill_count": len(list((REPO_ROOT / ".opencode" / "skills").glob("*/SKILL.md"))),
            "agent_count": len(list((REPO_ROOT / ".opencode" / "agents").glob("*.md"))),
    ...
    def list_files(project_name: str):
        ...
        files = []
        dirs = []
        skip = {".git", "__pycache__", ".venv", "node_modules", ".opencode"}
        allow_hidden = {".sibyl"}
        try:
